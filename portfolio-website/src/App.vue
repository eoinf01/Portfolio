    ...
    <div class="flex flex-col w-full h-full bg-white dark:bg-[#030303]">
      ...
      <aside id="socials"
        ...
        <h2
          ...
          socials.</h2>
        <ul
          class="socials-list list-none sm:absolute flex flex-row items-center sm:flex-col gap-1 sm:bottom-[27%] content-center">
          <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
            <a href="http://www.twitter.com/"><svg id="logo" class="scale-0 hover:fill-white fill-black dark:fill-white"
                fill="rgb(190, 190, 190)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="30px"
                height="30px">
                <path
          ...
          <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
            <svg id="logo" class="scale-0 fill-black dark:fill-white hover:fill-white" fill="rgb(190, 190, 190)"
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" width="30px" height="30px">
              <path
          ...
          <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
            <svg id="logo" class="scale-0 hover:fill-white fill-black dark:fill-white" fill="rgb(190, 190, 190)"
...
export default {
  ...
  mounted() {
    ...
    let rule = CSSRulePlugin.getRule('.socials-container:before');
    tl.from(rule, { duration: 1, height: '0%' })
