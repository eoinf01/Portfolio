<template>
  <div class="flex flex-col w-full h-full">
    <MenuHeader />
    <div class="flex items-start px-[3%] sm:px-[10%] justify-center flex-col">
      <router-view />
    </div>
    <aside class="socials-container flex flex-row sm:fixed sm:w-[10%] sm:flex-col sm:left-0 items-center justify-center sm:h-full sm:basis-[10%] lg:flex after:content-[''] after:h-[27%] after:absolute after:w-[2px] sm:after:bg-white after:bottom-0">
      <ul class="socials-list list-none sm:absolute flex flex-row items-center sm:flex-col gap-1 sm:bottom-[27%] content-center">
