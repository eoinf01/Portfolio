<template>
    ...
    <div class="flex flex-col bg-[#111112]">
        <ul
            class="sm:hidden list-none flex flex-row items-center gap-[10px] mt-[20px] justify-center content-center">
            <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
                <a href="http://www.twitter.com/"><svg
                        class=" hover:fill-white fill-black dark:fill-white" fill="rgb(190, 190, 190)"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="30px" height="30px">
                        <path
            ...
            <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
                <svg class=" fill-black dark:fill-white hover:fill-white" fill="rgb(190, 190, 190)"
            ...
            <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
                <svg class=" hover:fill-white fill-black dark:fill-white" fill="rgb(190, 190, 190)"
