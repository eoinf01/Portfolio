<template>
    ...
    <section class="mt-[60px] bg-[#111112]" id="contact">
        <div class="flex flex-col mt-[60px] justify-center px-[3%] sm:px-[10%] py-[5%]">
            ...
            <Form id="form" action="https://public.herotofu.com/v1/14cecf90-1351-11ed-a231-a93ebcec281d" method="post"
                class="m-auto mt-[60px] w-[70%] self-center flex flex-col justify-between items-center gap-[30px]"
                @submit="handleEmail" :validation-schema="emailSchema">
                <div class="flex flex-col sm:flex-row gap-[20px] grow w-full">
                    <div class="flex flex-col basis-6/12">
                        ...
                        <Field name="from_name" type="text" v-slot="{ field, errorMessage }">
                            <input type="text" placeholder="Enter your name" v-bind="field"
                                class="group-focus:placeholder:text-white border-b border-[#b5b5b5] transition-all duration-300 outline-none focus:border-white focus:border-b bg-transparent" />
                        </Field>
                    ...
                    <div class="flex flex-col basis-6/12">
                        ...
                        <Field name="reply_to" type="email" v-slot="{ field, errorMessage }">
                            <input type="text" placeholder="Enter your email address" v-bind="field"
                ...
                <div class="flex flex-col w-full">
                    ...
                    <Field name="message" type="text" v-slot="{ field, errorMessage, meta }">
                        <input type="text" placeholder="Enter your message" v-bind="field"
                            class="w-full border-b border-[#b5b5b5] transition-all duration-300 outline-none focus:border-white focus:border-b bg-transparent pb-[10px]" />
                    </Field>
                    <ErrorMessage name="message" class="text-red-600 text-xs" />

                </div>
                <div class="flex flex-row opacity-0 items-center justify-center mt-[30px]" id="button">
                <button
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="fill-white" class="w-6 h-6 text-white fill-white z-[2]">
...
<style>
.new-bg {
    background: radial-gradient(100% 225% at 0% 100%, #FF04F5 0%, #001AFF 100%), linear-gradient(270deg, #FB00A5 50%, #0400CB 100%), linear-gradient(300deg, #8DADA4 0%, #32DE81 100%), linear-gradient(7deg, #1DADFE 0%, #16009A 50%);
