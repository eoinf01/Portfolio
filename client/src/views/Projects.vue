<template>
    <div class="relative">
        ...
        <section class="grid grid-cols-12 gap-4 md:grid-cols-12 mt-[40px] px-[3%] sm:px-[10%] z-[2] mt-[100px]"
            ...
            <div class="flex flex-row col-start-1 col-end-13 justify-center items-center relative" v-if="getProjectLoadStatus">
            ...
            <div id="project" class="grid col-start-1 col-end-13 grid-cols-12 gap-5 auto-cols-max" v-for="project,index in fetchedProjects">
                <div id="project-info"
                    class="flex flex-col gap-[15px] transition-all duration-100 rounded-md z-[2] col-start-1 col-end-13 bg-[#1a1a1a] rounded-md m-auto hidden sm:flex opacity-0 sm:col-end-7" :class="{'sm:col-end-7': index%2==1, 'sm:col-start-7 sm:col-end-13': index%2==0}">
                    <div class="h-[25px] bg-mac-outer ">
                        <div class="flex h-full flex-row justify-start items-center gap-[10px] mx-[10px]">
                            <div class="h-[10px] w-[10px] rounded-full red" />
                            <div class="h-[10px] w-[10px] rounded-full orange" />
                ...
                <div class="flex col-start-1 col-end-13 sm:flex m-auto opacity-0" :id="index%2==0 ? 'image-left' : 'image-right'" :class="{'sm:col-start-7 sm:col-end-13': index%2==1, 'sm:col-start-1 sm:col-end-7 order-first': index%2==0}">
                    <div
                        ...
                        <div
                            ...
                            <div class="flex flex-col-reverse h-full p-[3%] sm:hidden justify-between">
                                ...
                                <div class="flex flex-row gap-[10px] justify-end" v-for="technology in project.technologies">
