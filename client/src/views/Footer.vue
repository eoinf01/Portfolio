  ...
  <div class="flex flex-col bg-[#111112]">
    <ul class="sm:hidden list-none flex flex-row items-center gap-[10px] mt-[20px] justify-center content-center">
      <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
        <a href="https://github.com/eoinf01" target="_blank"><svg
      ...
      <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
        <a href="https://www.linkedin.com/in/eoinfehily/" target="_blank">
          <svg class="scale-0 fill-black dark:fill-white hover:fill-white" fill="rgb(190, 190, 190)"
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30px" height="30px">
            <path
      ...
      <li class="transition-all hover:text-white hover:translate-y-[-2px] cursor-pointer">
        <a href="https://www.instagram.com/eoinyf/" target="_blank">
          <svg class="scale-0 fill-black dark:fill-white hover:fill-white" width="25" height="25"
